sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("tumblr/corinzio/manageproducts/app", ".html");
		...
		return Opa5.extend("tumblr.corinzio.manageproducts.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["tumblr/corinzio/manageproducts/localService/mockserver"], function (mockserver) {
